...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if county_names not in county_names:
        ...
        with open(file_to_save, 'w') as txt_file:
            ...
            # print the final vote count( terminal)
            election_results =(        
                f"\nElection Results\n"
                f"---------------------\n"
    ...
    for county_name in county_votes:
        ...
        county_results = (
            f"{county_name} : {county_percentage:.if}% ({county:,})\n")
    ...
    winning_county_summary = (
        ...
        f"winning county percentage: {winning_c_percentage:.if}%\n"
        f"--------------------\n\n"
